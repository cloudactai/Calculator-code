...
export const formsService = {
  ...
  saveGeneratedPdf: async (matterNumber, documentId, revision, pdfBase64) => body(await axios.put(`/matters/${encodeURIComponent(matterNumber)}/forms/${documentId}/pdf`, { revision, pdfBase64 })),
