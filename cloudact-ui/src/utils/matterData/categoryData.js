const incomeDetails = [
  {
    ...
    value: "Employment income (before deductions)",
  },
  {
...
const incomeDetailsBC = [
  ...
  {
    name: "Workers compensation benefits",
  ...
  {
    name: "Government assistance income",
    value: "Government assistance income",
  },
  {
    name: "Trust income",
    value: "Trust income",
...
const assetsDetails = [
  ...
  {
    name: "Household Goods, Furniture and Fixtures",
    value: "Household Goods, Furniture and Fixtures",
  },
  {
    name: "Jewelery, art, electronics, tools,sports & hobby equipment",
    value: "Jewelery, art, electronics, tools,sports & hobby equipment",
  },
  {
    name: "Other Special Items",
    value: "Other Special Items",
  },
  {
    name: "Other Assets",
    value: "Other Assets",
...
const expenseDetailsBC = [
  { name: "Automatic deductions", value: "Automatic deductions" },
  { name: "Rent/Mortgage", value: "Rent/Mortgage" },
  {
    name: "Property taxes an strata fees",
    value: "Property taxes an strata fees",
  },
  {
    name: "Home owner/renter's Insurance",
    value: "Home owner/renter's Insurance",
  },
  { name: "Home maintenance and repair", value: "Home maintenance and repair" },
  { name: "Other Housing expense", value: "Other Housing expense" },
  { name: "Utilities", value: "Utilities" },
  { name: "Groceries", value: "Groceries" },
  { name: "Household supplies", value: "Household supplies" },
  { name: "Eating out", value: "Eating out" },
  { name: "Other Household expenses", value: "Other Household expenses" },
  {
    name: "Public transit, taxis and parking",
    value: "Public transit, taxis and parking",
  },
  { name: "Fuel", value: "Fuel" },
  {
    name: "Car insurance and car loan payment",
    value: "Car insurance and car loan payment",
  },
  { name: "Maintenance and repairs", value: "Maintenance and repairs" },
  { name: "Other Transportation", value: "Other Transportation" },
  { name: "Health and Medical", value: "Health and Medical" },
  { name: "Clothing and self care", value: "Clothing and self care" },
  { name: "Children expenses", value: "Children expenses" },
  {
    name: "Premiums, Contributions and Debt Repayment",
    value: "Premiums, Contributions and Debt Repayment",
  },
  { name: "Miscelleneous/Other", value: "Miscelleneous/Other" },
];

const expenseDetailsAB = [
  { name: "Rent or Mortgage payments", value: "Rent or mortgage" },
  { name: "Property tax", value: "Property taxes" },
  { name: "Property insurance", value: "Property insurance" },
  { name: "Condominium fees", value: "Condominium fees" },
  { name: "Utilities", value: "Utilities" },
  { name: "Repairs and maintenance", value: "Repairs and maintenance" },

  { name: "Food and Household supplies", value: "Food and Household supplies" },
  { name: "Laundry and dry cleaning", value: "Laundry and dry cleaning" },
  {
    name: "Telephone, Cable TV and Internet fees",
    value: "Telephone, Cable TV and Internet fees",
  },

  { name: "Personal hygiene", value: "Personal hygiene" },
  { name: "Clothing", value: "Clothing" },
  { name: "Prescriptions and medicines", value: "Prescriptions and medicines" },
  { name: "Educational expenses", value: "Educational expenses" },
  { name: "Life insurance", value: "Life insurance" },
  {
    name: "Medical and Dental insurance",
    value: "Medical and Dental insurance",
  },
  {
    name: "Birthday and Christmas gifts",
    value: "Birthday and Christmas gifts",
  },
  {
    name: "Entertainment and recreation",
    value: "Entertainment and recreation",
  },
  { name: "Vacation", value: "Vacations" },

  { name: "Auto insurance", value: "Auto insurance" },
  { name: "License and registration", value: "License and registration" },
  { name: "Gas and oil", value: "Gas and oil" },
  { name: "Parking", value: "Parking" },
  { name: "Auto servicing", value: "Auto servicing" },
  { name: "Public transit and taxis", value: "Public transit and taxis" },

  { name: "Support for others", value: "Support for others" },
  { name: "Credit card payment", value: "Credit card payment" },
  { name: "Bank loan payment", value: "Bank loan payment" },
  { name: "Other debt payment", value: "Other debt payment" },
