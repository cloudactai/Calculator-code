...
const ComplianceHeader = ({ data }) => {
    ...
    let { title, customYearModal,
        setCustomYearModal,
        setHeaderDateData,
        headerDateData, handleSearchButton,
        setArchiveFilter,
        ArchiveFilter,
        handleArchiveForms,
    } = data;
        ...
        <>
               ...
               title != "Compliance Forms"  &&
                <div className="form-group m-0 rounded-pill">
...

                    {
                        ...
                        <Nav.Item>
                          <Nav.Link  className="font-weight-bold"  active={ArchiveFilter === "Compliance Form"} eventKey="Compliance Form">ComplianceForm</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
            ...
            <div className="control">
                ...
                {(getCurrentUserFromCookies().role === Roles.ADMIN || getCurrentUserFromCookies().role === Roles.PREPARER) && (
                    ...
                    <Link
                        className={`btn btnPrimary rounded-pill ${title == "Compliance Forms" ? "d-none" : ""}`}

                        to={{
                            pathname: title == "Trust Deposit Slip" ? AUTH_ROUTES.CREATE_TASKS_TRUST_DEPOSIT_SLIP  : AUTH_ROUTES.CREATE_TASKS,
                            search: title == "Trust Deposit Slip" ? "" : "type=COMPLIANCE_FORM",
                        }}
                    >
                      {title == "Trust Deposit Slip" ? "Generate Trust Deposit Slip" : "  Add compliance form"}
                    </Link>
                )}
