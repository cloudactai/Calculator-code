"""Re-check the promoted Prince Edward Island set end to end.
...
def main():
    ...
    rows = {r["docId"]: r for r in catalog if r.get("province") == "PE"}
    ...
    print("PEI: %d templates, %d pages, %d fields, %d binds"
